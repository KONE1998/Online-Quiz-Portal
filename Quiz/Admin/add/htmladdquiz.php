...
<div class="container">
  <form action="htmladdquiz.php" method="post">
    <div class="row">
      <div class="col-25">
  ...
  <h2>Set New Timer</h2>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="min" name="min" placeholder="Enter the Minutes">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="sec" name="sec" placeholder="Enter the Seconds">
      </div>
      </div>   
    
    <div class="row">
      <button type="submit" value="Add Time" name="timesubmit">ADD Timer</button>
    </div>
  </form></div>
