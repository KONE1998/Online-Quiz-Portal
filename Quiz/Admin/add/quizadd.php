...
$qry = "INSERT INTO `html`(`id`,'title', `que`, `option 1`, `option 2`, `option 3`, `option 4`, `ans`) VALUES ($id,'$title','$que','$ans','$wans1','$wans2','$wans3','$ans')";
...
@$sec = $_POST['sec'];
$timer = $min.':'.$sec;
$fetchqry3 = "UPDATE `html` SET `timer`='$timer' WHERE`id`=1";
