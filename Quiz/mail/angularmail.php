<?php
// this file is called from angularjs/app.js
//example of sending mail from angularjs
error_log("Entered angularmail.php");
...
// return a response ===========================================================
	...
	if ( ! empty($errors)) {
		...
		$data['errors']  = $errors;
		 ...
		 error_log("Entered angularmail.php: Sending mail");
